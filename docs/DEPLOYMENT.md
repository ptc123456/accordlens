...
- Immutable deployment URL: `https://accordlens-64qcm0ws6-shingg.vercel.app`
- Status: `READY`
- Runtime bundle: `/assets/index-BIbCgchR.js`
- Bundle SHA-256: `B8EF0D287EAAF50B1F801197CEB07EB9D06369C2A0F4BD517491A6824F28FDF6`

The stable URL is the public judge-facing entry point. The immutable deployment URL identifies the exact Vercel deployment and may be subject to the owner's Vercel access policy.
